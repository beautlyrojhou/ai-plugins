...
| `navigating-the-initiative-funnel`   | Tech lead's role across the five phases of Bitwarden's Software Initiative Funnel, with emphasis on epic breakdown during Scoping & Commitment         |
| `receiving-work-transitions`         | Receiving-side playbook for Bitwarden's Work Transition Playbook: preparation, sessions, support period, pulse check, retrospective, closure           |
